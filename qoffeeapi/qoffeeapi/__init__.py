...
from qoffeeapi.orchestrator import OrchestratorDrinkRequestHandler, OrchestratorListMachineHaIdHandler, OrchestratorMachineStateHandler, OrchestratorMachineHaIdHandler
...
def load_jupyter_server_extension(nb_server_app):
    ...
    # list homeappliences
    route_pattern = url_path_join(web_app.settings['base_url'], '/homeappliances')
    web_app.add_handlers(host_pattern, [(route_pattern, OrchestratorListMachineHaIdHandler)])
